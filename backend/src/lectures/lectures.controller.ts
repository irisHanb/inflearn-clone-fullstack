...
export class LecturesController {
  ...
  @UseGuards(AccessTokenGuard)
  @ApiBearerAuth('access-token')
  @ApiOperation({ summary: '개별 강의 상세 정보 수정' })
  @ApiParam({
    name: 'lectureId',
    description: '개별 강의 ID',
  })
  ...
  @ApiOkResponse({
    description: '개별 강의 삭제',
    type: LectureEntity,
  })
  remove(@Param('lectureId') lectureId: string, @Req() req: Request) {
